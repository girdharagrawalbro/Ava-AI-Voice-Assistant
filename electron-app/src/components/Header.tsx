...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={`flex items-center justify-between px-6 py-4 ${isHomePage ? '' : 'bg-white/80 dark:bg-slate-900/80 shadow-md border-b border-slate-200 dark:border-slate-800 z-20'}`}>
      <motion.div
