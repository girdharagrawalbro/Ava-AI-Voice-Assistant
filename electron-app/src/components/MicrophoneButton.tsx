    ...
    <div className="relative flex items-center justify-center">
      ...
      >
        ...
        <motion.div
          ...
          style={
            {
              backgroundImage: `conic-gradient(from 0deg, transparent, ${isListening
      ...
      <motion.div
        className="absolute -bottom-9  transform -translate-x-1/2"
      ...
      >
        <motion.span
          className={classNames(
            "text-sm font-semibold w-full px-2 py-2 rounded-full backdrop-blur-md border transition-all duration-300",
            isListening
